      ...
      <div className="auth-brand" style={{ flex: '1 1 52%', display: 'none' }}>
        <div style={{ padding: 40, maxWidth: 460 }}>
          ...
          <h1 style={{ color: '#fff', fontSize: 38, lineHeight: 1.15, fontWeight: 900, letterSpacing: '-0.03em', margin: '0 0 16px' }}>
            Tenant Anda sendiri,<br /><em style={{ fontStyle: 'normal', color: '#34D399' }}>terisolasi penuh</em>.
          </h1>
      ...
      <div style={{ flex: '1 1 48%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 32 }}>
        <form onSubmit={submit} style={{ width: 400 }}>
          <div style={{ marginBottom: 26 }}>
            ...
            <p style={{ color: '#5B6B80', margin: '6px 0 0', fontSize: 14 }}>Anda menjadi admin tenant baru.</p>
          </div>
          ...
          <div className="form-group"><label className="form-label">Password <span style={{ color: '#5B6B80', fontWeight: 500 }}>(min. 8)</span></label><input className="form-input" style={{ padding: '12px 14px' }} type="password" value={form.password} onChange={set('password')} /></div>
          ...
          <p style={{ textAlign: 'center', marginTop: 22, fontSize: 14, color: '#5B6B80' }}>
            Sudah punya akun? <Link href="/login" style={{ color: '#059669', fontWeight: 700 }}>Masuk</Link>
          </p>
        </form>
      </div>
